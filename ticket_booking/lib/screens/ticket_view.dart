                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      SizedBox(
                        width: 100,
                        child: Text(ticket['from']['name'], style: Styles.headLineStyel4.copyWith(color: Colors.white),),
                      ),
                      Text(ticket['flying_time'], style: Styles.headLineStyel4.copyWith(color: Colors.white),),
                      SizedBox(
                        width: 100,
                        child: Text(ticket['to']['name'], textAlign: TextAlign.end, style: Styles.headLineStyel4.copyWith(color: Colors.white),),
                      ),
                    ],
                  )
                ],
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          const Gap(5),
                          Text('Date', style: Styles.headLineStyel4.copyWith(color: Colors.white),),
                        ],
                      ),
                      Column(
                        ...
                        children: [
                          ...
                          const Gap(5),
                          Text('Departure Time', style: Styles.headLineStyel4.copyWith(color: Colors.white),),
                        ],
                      ),
                      Column(
                        ...
                        children: [
                          ...
                          const Gap(5),
                          Text('Number', style: Styles.headLineStyel4.copyWith(color: Colors.white),),
                        ],
                      ),
                    ],
                  )
